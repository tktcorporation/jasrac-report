...
export function SearchResults({
  ...
  // 他の候補で差し替える関数
  const replaceResultWithAlternative = (resultIndex: number, altIndex: number) => {
    setResults((prev) => {
      ...
      const newAlts = [current, ...current.alternatives.filter((_, i) => i !== altIndex)];
  ...
  if (results.length === 0 && !isLoading && !isPollingLogs) {
    return <div className="text-center py-10 text-gray-500">検索結果はまだありません</div>;
  }
                          ...
                          <TableRow key={`result-${result.workCode}`}>
                            ...
                            <TableCell>
                              <div className="flex flex-wrap gap-1">
                                ...
                                {result.usagePermissions?.reproduction?.recording && (
                                  <Badge variant="outline" className="bg-green-50">
                                    録音
                                  </Badge>
                                )}
                                {result.usagePermissions?.transmission?.broadcast && (
                                  <Badge variant="outline" className="bg-amber-50">
                                    放送
                                  </Badge>
                                )}
                                {result.usagePermissions?.transmission?.distribution && (
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  <div>
                    <span className="font-medium">作詞者:</span> {selectedDetail.lyricist}
                  </div>
                  <div>
                    <span className="font-medium">作曲者:</span> {selectedDetail.composer}
                  </div>
                  <div>
                  ...
                  <div>
                    <span className="font-medium">編曲者:</span> {selectedDetail.arranger || "-"}
                  </div>
                  <div>
                    <span className="font-medium">出版者:</span> {selectedDetail.publisher || "-"}
                  </div>
                  <div>
                    <span className="font-medium">作品種別:</span> {selectedDetail.workType || "-"}
                  </div>
                  <div>
                    <span className="font-medium">国籍:</span> {selectedDetail.nationality || "-"}
                  </div>
                  <div>
                  ...
                  <div className="border rounded p-3">
                    ...
                    <ul className="space-y-1">
                      <li>
                        ...
                        >
                          {selectedDetail.usagePermissions?.performance?.concert ? "可" : "不可"}
                        </Badge>
                      </li>
                      <li>
                        <span>BGM:</span>{" "}
                        ...
                        >
                          {selectedDetail.usagePermissions?.performance?.bgm ? "可" : "不可"}
                        </Badge>
                      </li>
                      <li>
                        <span>カラオケ:</span>{" "}
                        ...
                        >
                          {selectedDetail.usagePermissions?.performance?.karaoke ? "可" : "不可"}
                        </Badge>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="border rounded p-3">
                    ...
                    <ul className="space-y-1">
                      <li>
                        ...
                        >
                          {selectedDetail.usagePermissions?.reproduction?.recording ? "可" : "不可"}
                        </Badge>
                      </li>
                      <li>
                        <span>出版:</span>{" "}
                        <Badge
                          variant={
                            selectedDetail.usagePermissions?.reproduction?.publication
                              ? "default"
                              : "outline"
                          }
                          className={
                  ...
                  <div className="border rounded p-3">
                    ...
                    <ul className="space-y-1">
                      <li>
                        ...
                        >
                          {selectedDetail.usagePermissions?.transmission?.broadcast ? "可" : "不可"}
                        </Badge>
                      </li>
                      <li>
                        <span>配信:</span>{" "}
                        <Badge
                          variant={
                            selectedDetail.usagePermissions?.transmission?.distribution
                              ? "default"
                              : "outline"
                          }
                          className={
