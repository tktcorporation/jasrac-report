    ...
    <div>
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>検索したい曲の情報を入力してください</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>検索対象の曲リスト ({songList.length}曲)</CardDescription>
        </CardHeader>
        <CardContent>
          {songList.length > 0 ? (
                ...
                <TableBody>
                  {songList.map((song, index) => (
                    <TableRow key={`song-${song.title}-${index}`}>
                      ...
                      <TableCell>
                        <Button variant="outline" size="sm" onClick={() => removeSong(index)}>
                          削除
                        </Button>
                      </TableCell>
                    </TableRow>
            ...
            <div className="text-center py-6 text-gray-500">曲が追加されていません</div>
          )}
        </CardContent>
        <CardFooter>
          <Button
