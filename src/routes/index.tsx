...
import { getJasracResults, getPlaywrightLogs, searchJasracInfo } from "../lib/jasrac-bridge";
...
function App() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 text-center">JASRAC情報検索・申請ツール</h1>
      ...
      {activeTab === "results" && (
        <>
          {searchError ? (
            <div className="bg-red-50 p-4 rounded-md text-red-800 mb-4">{searchError}</div>
          ) : null}
